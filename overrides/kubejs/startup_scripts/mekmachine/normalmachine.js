StartupEvents.registry('item', event => {
    let nmachines = ["冶金吹込器", "濃縮室", "オスミウム圧縮機", "粉砕機", "浄化室"]
    let nmachines_id = ["metallurgic_infuser", "enrichment_chamber", "osmium_compressor", "crusher", "purification_chamber", "energized_smelter", "electric_pump", 'logistical_sorter']
